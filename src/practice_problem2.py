...
# Test 1
    expected = [14, 22, 17, -8, 20]
    actual = practice_problem2a([8, 16, 11, -14, 14], 6)
    print("Expected: ", expected)
    print("Actual:   ", actual)

# Test 2
    expected = [11, 12, 13, 14, 15]
    actual = practice_problem2a([1, 2, 3, 4, 5], 10)
    print("Expected: ", expected)
    print("Actual:   ", actual)

# Test 3
    expected = [3, -3, 204, -5, 69]
    actual = practice_problem2a([1, -5, 202, -7, 67], 2)
    print("Expected: ", expected)
    print("Actual:   ", actual)
...
def practice_problem2a(sequence, delta):
    ...
    for k in range(len(sequence)):
        sequence2 = sequence2 + [sequence[k] + delta]
    return sequence2
